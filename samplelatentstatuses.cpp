...
NumericVector samplelatents(int N,NumericVector p,NumericMatrix Y,NumericMatrix G,NumericVector W,NumericVector U,NumericVector se,NumericVector sp) {
	...
	for(int i=0; i<N; i++){
		...
		for(int j=0; j<np; j++){
			tmp = Y(i,(j+2+1)) - 1;	// obtain a pool this individual was assigned to
